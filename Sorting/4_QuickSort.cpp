...
// Quick Sort using INT_MAX or INFINITY -> O(n log n)
...
// Last Element is Pivot + without using INT_MAX or INFINITY -> O(n^2)
...
// First Element is Pivot + without using INT_MAX or INFINITY -> O(n^2)
...
int main()
{
    ...
    int A[] = {3, 7, 9, 10, 6, 5, 12, 4, 11, 2, __INT_MAX__};
